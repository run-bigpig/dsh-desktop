...
import { attachmentRef, type ImageTaskRecord, type ImageVersionRecord, type StoredImageRef } from './image-task-store.ts'
import type { GeminiImageResolution, ImageQuality } from './image-adapters.ts'
