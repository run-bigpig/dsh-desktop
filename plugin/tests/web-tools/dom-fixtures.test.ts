...
import { extractVisibleXhsSearch, extractXhsNoteDetail } from "../../packages/plugin-host/src/web-tools/host/sources/browser-scripts/xiaohongshu.ts";
import { extractVisibleXTweets } from "../../packages/plugin-host/src/web-tools/host/sources/browser-scripts/x.ts";
