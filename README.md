...
桌面更新源固定为 `https://api.github.com/repos/run-bigpig/dsh-desktop/releases/latest`。Windows x64 Release 必须同时发布 `StarWeave-Setup-x64.exe` 和对应的 `.sha256` 文件；如果 GitHub API 已提供资产 digest，也会直接使用该 SHA-256。
