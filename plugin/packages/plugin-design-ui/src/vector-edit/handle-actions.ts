// Adapted from open-pencil/open-pencil v0.14.0, src/app/editor/vector-edit/handle-actions.ts
...
import { constrainContinuousTangent } from './handles.ts'
import { pushNodeEditHistory } from './history.ts'
import { getLiveNetwork } from './network.ts'
import type { NodeEditState } from './types.ts'
