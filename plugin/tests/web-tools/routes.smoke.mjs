...
import { registerRoutes, API_PREFIX } from "../../packages/plugin-host/src/web-tools/host/routes.ts";
...
test("removed platform endpoints return not found", async () => {
  const { status, body } = await call("platform/status");
