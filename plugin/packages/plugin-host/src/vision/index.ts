...
import { defineLookAtImageTool, lookAtArgFromImage, LOOK_AT_TOOL_NAME, type LookAtImageArg } from './tool.ts'
import type {
...
export function syntheticLookAtCallChunks(id: ReturnType<typeof ToolCallId>, args: string): StreamChunk[] {
  return [
