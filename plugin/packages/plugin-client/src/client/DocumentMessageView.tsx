...
import type { ChatNodeViewProps, MessageImagesOwnerProps } from '@deepseek-ai/dsh-client-ui-conversation/client'
...
function contentParts(content: readonly unknown[]): {
  ...
  const texts: string[] = []
  const images: { attachment: MessageImagesOwnerProps['images'][number]['attachment'] }[] = []
  const rest: unknown[] = []
  for (const block of content) {
    const candidate = block as {
      type?: string
      text?: string
      attachment?: MessageImagesOwnerProps['images'][number]['attachment']
    }
...
export const DocumentMessageView = memo(function DocumentMessageView({
