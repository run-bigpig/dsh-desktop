...
import type { CdpPageLease } from "../../packages/plugin-host/src/web-tools/host/browser/types.ts";
import {
  focusVisibleXhsSearchInput,
  navigateXhsSearchViaUi,
} from "../../packages/plugin-host/src/web-tools/host/sources/xiaohongshu/ui-search.ts";
