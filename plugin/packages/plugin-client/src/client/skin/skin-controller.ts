...
export const DEFAULT_BRAND_TITLE = '星织 StarWeave'
export const DEFAULT_HERO_HEADLINE = '连接智能,星织万界'
export const DEFAULT_HERO_PREVIEW = '探索版'
...
export const DEFAULT_SKIN_SETTINGS: Readonly<SkinSettings> = Object.freeze({
  ...
  heroPreview: DEFAULT_HERO_PREVIEW,
})
...
/** Keep Theme Runtime and the desktop-owned background synchronized with persisted settings. */
