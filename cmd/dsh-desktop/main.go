...
func main() {
	...
	app = application.New(application.Options{Name: "DeepSeek Harness Desktop", Description: "Independent desktop runtime for the official DeepSeek Harness web UI", Icon: icons.ApplicationLightMode256, Logger: logger,
