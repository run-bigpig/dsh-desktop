...
import { extractXhsSearchState, extractXhsDetailState, extractXhsCommentState } from "../../packages/plugin-host/src/web-tools/host/sources/browser-scripts/xiaohongshu.ts";
import { buildXhsNoteUrl } from "../../packages/plugin-host/src/web-tools/host/sources/xiaohongshu/query.ts";
import { parseXhsMetricNumber, isNoteFeed, normalizeXhsFeed } from "../../packages/plugin-host/src/web-tools/host/sources/xiaohongshu/normalize.ts";
import type { XhsRawSearchFeed } from "../../packages/plugin-host/src/web-tools/host/sources/xiaohongshu/types.ts";
